  ...
  <div class="login-box">
    <el-form ref="ruleFormRef" :model="ruleForm" status-icon :rules="rules" label-width="80px" class="demo-ruleForm">
      ...
      <el-form-item label="密码: " prop="password">
        <el-input v-model="ruleForm.password" type="password" @keyup.enter="submitForm(ruleFormRef)"
          autocomplete="off" />
      </el-form-item>
      <el-form-item>
    ...
    <a href="https://github.com/Alexie7777/shopping-system-Vue3TS" class="github-corner"
